...
#define KEEPALIVES_IDLE      "keepalives_idle"   /* Default keepalives_idle */
#define KEEPALIVES_INTERVAL      "keepalives_interval"   /* Default keepalives_interval */
#define KEEPALIVES_COUNT      "keepalives_count"   /* Default keepalives_count */
#define CLIENT_ENCODING      "client_encoding"   /* Default client_encoding */
#define APPLICATION_NAME      "application_name"   /* Default application_name */
#define TCP_USER_TIMEOUT      "tcp_user_timeout"   /* Default tcp_user_timeout */
#define SSLCOMPRESSION      "sslcompression"   /* Default sslcompression */
#define SSLCERT           "sslcert"   /* Default sslcert */
#define SSLKEY          "sslkey"   /* Default sslkey */
#define SSLROOTCERT      "sslrootcert"   /* Default sslrootcert */
#define SSLCRL        "sslcrl"   /* Default sslcrl */
#define REQUIREPEER      "requirepeer"   /* Default requirepeer */
#define KRBSRVNAME      "krbsrvname"   /* Default krbsrvname */
#define GSSLIB         "gsslib"   /* Default gsslib */
#define SERVICE      "service"   /* Default service */
#define REMOTE_NODENAME      "remote_nodename"   /* Default remote_nodename */
#define LOCALHOST      "localhost"   /* Default localhost */
#define LOCALPORT      "localport"   /* Default localport */
#define REPLICATION      "replication"   /* Default replication */
#define BACKEND_VERSION      "backend_version"   /* Default backend_version */
#define PROTOTYPE      "prototype"   /* Default prototype */
#define ENABLE_CE      "enable_ce"   /* Default enable_ce */
