...
typedef struct
{
    ...
    char        client_encoding[MEDIUM_REGISTRY_LEN];
    char        application_name[MEDIUM_REGISTRY_LEN];
    char        sslcompression[SMALL_REGISTRY_LEN];
    char        sslcert[MEDIUM_REGISTRY_LEN];
    char        sslkey[MEDIUM_REGISTRY_LEN];
    char        sslrootcert[MEDIUM_REGISTRY_LEN];
    char        sslcrl[MEDIUM_REGISTRY_LEN];
    char        requirepeer[MEDIUM_REGISTRY_LEN];
    char        krbsrvname[MEDIUM_REGISTRY_LEN];
    char        gsslib[MEDIUM_REGISTRY_LEN];
    char        service[MEDIUM_REGISTRY_LEN];
    char        remote_nodename[MEDIUM_REGISTRY_LEN];
    char        localhost[MEDIUM_REGISTRY_LEN];
    char        localport[MEDIUM_REGISTRY_LEN];
    char        replication[MEDIUM_REGISTRY_LEN];
    char        backend_version[MEDIUM_REGISTRY_LEN];
    char        prototype[MEDIUM_REGISTRY_LEN];
    char        keepalives_count[MEDIUM_REGISTRY_LEN];
    char        tcp_user_timeout[MEDIUM_REGISTRY_LEN];
    char        enable_ce[SMALL_REGISTRY_LEN];
    char        keepalives_idle[MEDIUM_REGISTRY_LEN];
    char        keepalives_interval[MEDIUM_REGISTRY_LEN];
